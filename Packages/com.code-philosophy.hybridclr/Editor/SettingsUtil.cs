...
namespace HybridCLR.Editor
{
    public static class SettingsUtil
    {
        ...
        public readonly static string GameAppHotUpdateDllDir = Path.GetFullPath($"{Application.dataPath}/Plugins");

        public readonly static string GameAppHotUpdateDllBytesDir = Path.GetFullPath($"{Application.dataPath}/StreamingAssets/HotUpdateDlls");

        /// <summary>
        /// 补充元数据二进制文件放置目录
        /// </summary>
        public readonly static string SupplementalMetadataDir = Path.GetFullPath($"{Application.dataPath}/StreamingAssets/HotUpdateDlls");
